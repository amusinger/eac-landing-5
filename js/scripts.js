...
$(document).ready(function(){
	...
	$(function(){
		...
		$('.percentagebar div').fadeTo(0, 0).waypoint(function()
		{
			...
			$(this).fadeTo(1000,1).addClass("percent80");
		},
		{
			offset: '100%',
			triggerOnce: true
	...
	$(function(){
		...
		$('.post, .post-bubbles, h2, h3, h1, img').fadeTo(0, 0).waypoint(function()
		{
			$(this).fadeTo(2000,2).addClass("animated fadeInUp");
		},
		{
			offset: '100%',
			triggerOnce: true
...
$(document).ready(function() {
	$('.bxslider').bxSlider({
		auto: true,
		pause: 5000,
		mode: 'horizontal', /** face, horizontal, vertical **/
		useCSS: true,
		controls: false,
		speed: 700,
...
$(document).ready(function(){
	$("#countdown").countdown({
		date: "12 june 2017 12:00:00", /** Enter new date here **/
		format: "on"
	},
	function() {
		// callback function
